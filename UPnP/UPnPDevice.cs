		...
		*/
                ...
                if (IsRoot == true)
                {
                    ...
                    else
                    {
                        if (ManualIPEndPoint != null)
                            SendBye(this.ManualIPEndPoint.Address);
                    }
        ...
        private void SendBye(IPAddress local)
        {
            ...
            for (int x = 0; x < Response.Length; ++x)
                SSDPServer.BroadcastData(Response[x], local);
        }
                    ...
                    if (MethodTag != "QueryStateVariable")
                    {
                        ...
                        foreach (UPnPArgument arg in A.Arguments)
                        {
                            if (arg.IsReturnValue == true)
                                iis.RetArg = (UPnPArgument)arg.Clone();
